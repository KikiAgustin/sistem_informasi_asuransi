...
<head>
    <title>ASURANSIKU | Halaman Login</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="limiter">
        <div class="container-login100">
            <div style="margin-bottom: 5px; " class="flash">
            ...
            <div class="wrap-login100">
                ...
                <form method="POST" action="" class="login100-form validate-form">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Password harus disi">
                    ...
                    <div class="text-center p-t-136">
                        <a class="txt2" href="<?= base_url("Auth/registrasi"); ?>">
                            Buat Akun Baru
