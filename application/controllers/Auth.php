...
class Auth extends CI_Controller
{
    ...
    private function _login()
    {
        ...
        if ($user) {
            ...
            if ($user['is_active'] == 1) {
                ...
                $this->session->set_flashdata('auth_user', '<h3 style="color: red;" >Email belum aktif</h3>');
                redirect('Auth');
            }
        } else {
            $this->session->set_flashdata('auth_user', '<h3 style="color: red;" >Email tidak terdaftar</h3>');
            redirect('Auth');
        }
    }
    ...
    public function registrasi()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('message', '<h3>Selamat registrasi anda berhasil</h3>');
            redirect('Auth');
        }
    }
